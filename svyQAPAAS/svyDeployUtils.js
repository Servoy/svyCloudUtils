 ...
 * @param {String} [migrationFilesFolder] Media foldername where all the migration files should be located. Default: database-migration
 *
 ...
 * @properties={typeid:24,uuid:"AF97E9C4-4FE4-4C99-95E1-1B6F4C51EAE0"}
 */
